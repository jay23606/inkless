create table public.il_document_files (
...
alter table public.il_document_files enable row level security;
create policy "document_files_owner_read" on public.il_document_files for select to authenticated
